					...
					if file.endswith(ext):
						...
						for row in csvreader:
							if primerElemento == 0:
								...
								platform = row[5]
								fileName = row[6]
								stringInfo = ("0002"+nombre+" "+md5+" "+str(sizeFile)+" "+str(version)+" "+str(arch)+" "+str(platform)+" "+str(fileName))
								sizeStringInfo = str(len(stringInfo)+4)
								# ~ print(len(sizeStringInfo))
								if(len(sizeStringInfo) == 1):
									sizeStringInfo = "000"+str(sizeStringInfo)
								elif(len(sizeStringInfo) == 2):
									sizeStringInfo = "00"+str(sizeStringInfo)
								elif(len(sizeStringInfo) == 3):
									sizeStringInfo = "0"+str(sizeStringInfo)
								self.listaArchivos.append(sizeStringInfo+stringInfo)
...
# ~ files = ServiceAdvertisement("/archivos")
